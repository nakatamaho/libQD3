...
function(qd3_define_options)
  ...
  option(QD_ENABLE_BF "Use branch-free addition and multiplication" OFF)
  option(QD_ENABLE_BF_ADD "Use branch-free addition" OFF)
  option(QD_ENABLE_BF_MUL "Use branch-free multiplication" OFF)
  ...
  option(QD3_ENABLE_MPFR_TESTS "Build the optional MPFR oracle test suite" OFF)
  option(QD3_ENABLE_MPC_TESTS "Build the optional MPC complex oracle test suite" OFF)
  option(QD3_ENABLE_ASAN "Build QA targets with AddressSanitizer instrumentation" OFF)
  option(QD3_ENABLE_UBSAN "Build QA targets with UndefinedBehaviorSanitizer instrumentation" OFF)
  option(QD3_ENABLE_COVERAGE "Build QA targets with coverage instrumentation and add a coverage target" OFF)
...
function(qd3_normalize_options)
  ...
  qd3_normalize_bool_option(QD_ENABLE_BF)
  qd3_normalize_bool_option(QD_ENABLE_BF_ADD)
  qd3_normalize_bool_option(QD_ENABLE_BF_MUL)
  ...
  qd3_normalize_bool_option(QD3_ENABLE_MPFR_TESTS)
  qd3_normalize_bool_option(QD3_ENABLE_MPC_TESTS)
  qd3_normalize_bool_option(QD3_ENABLE_ASAN)
  qd3_normalize_bool_option(QD3_ENABLE_UBSAN)
  qd3_normalize_bool_option(QD3_ENABLE_COVERAGE)
  ...
  if(QD_ENABLE_BF)
    set(QD_ENABLE_BF_ADD ON)
    set(QD_ENABLE_BF_MUL ON)
  endif()
  ...
  set(QD_ENABLE_BF "${QD_ENABLE_BF}" PARENT_SCOPE)
  set(QD_ENABLE_BF_ADD "${QD_ENABLE_BF_ADD}" PARENT_SCOPE)
  set(QD_ENABLE_BF_MUL "${QD_ENABLE_BF_MUL}" PARENT_SCOPE)
  ...
  set(QD3_ENABLE_MPFR_TESTS "${QD3_ENABLE_MPFR_TESTS}" PARENT_SCOPE)
  set(QD3_ENABLE_MPC_TESTS "${QD3_ENABLE_MPC_TESTS}" PARENT_SCOPE)
  set(QD3_ENABLE_ASAN "${QD3_ENABLE_ASAN}" PARENT_SCOPE)
  set(QD3_ENABLE_UBSAN "${QD3_ENABLE_UBSAN}" PARENT_SCOPE)
  set(QD3_ENABLE_COVERAGE "${QD3_ENABLE_COVERAGE}" PARENT_SCOPE)
endfunction()
