...
| [tests/complex_test.cpp](tests/complex_test.cpp) | Default complex smoke test. |
...
| [tests/oracle/fn_registry.h](tests/oracle/fn_registry.h) | Shared oracle operation registry and error bounds. |
